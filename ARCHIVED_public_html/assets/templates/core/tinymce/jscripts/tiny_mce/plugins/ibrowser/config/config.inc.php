...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/assets/templates/lgv/pictures/',												
			'text'    	=> 'Pictures',
		),
		array (
			'value'   	=> '/assets/templates/lgv/gallery/', 				
			'text'    	=> 'Gallery',
		),	
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array('/home3/landgoed/public_html/assets/templates/lgv/pictures/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
