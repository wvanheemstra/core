...
var YoutubeDialog = {
    ...
    insert: function () {
        ...
        //Codes
        var iFrame = '<div class="flex-video"><iframe width="'+width+'" height="'+height+'" src="http://www.youtube.com/embed/'+code+'?wmode=transparent" frameborder="0" allowfullscreen></iframe></div>';
        var embeded = '\
