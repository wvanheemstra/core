...
<head>
	...
	<!-- Included CSS Files -->
	<style type="text/css">@import url("[[~46]]");</style>
	[[$core.CSSLinksTpl]]
...
<body style="background-image:url('assets/templates/core/images/backgrounds/[[getResources? &resources=`[[++custom.site_settings]]` &tpl=`core.SiteBackgroundTpl` &includeTVs=`1` &processTVs=`1` &parents=`-1` &limit=`1` &tvPrefix=``]]')">
	...
	<div class="container">
		<header class="row">
			<div class="twelve columns centered hide-for-touch" style="background: url('assets/templates/[[++custom.domain_abbreviation]]/images/logo_banner_small.png') no-repeat;width:970px;height:160px;margin-top:6px;margin-bottom:8px;"><div style="float:right;color:#ffffff;margin-top:8px;margin-right:8px;">[[$core.CurrentDateTpl]]</div></div>
