...
-- ----------------------------
--  Table structure for `tbl_kind_of_activity`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_kind_of_activity`;
CREATE TABLE `tbl_kind_of_activity` (
...
delimiter ;;
CREATE TRIGGER `KindOfActivity.ts_Created` BEFORE INSERT ON `tbl_kind_of_activity` FOR EACH ROW BEGIN
