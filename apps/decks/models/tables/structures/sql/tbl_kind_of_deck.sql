...
-- ----------------------------
--  Table structure for `tbl_kind_of_deck`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_kind_of_deck`;
CREATE TABLE `tbl_kind_of_deck` (
...
delimiter ;;
CREATE TRIGGER `KindOfDeck.ts_Created` BEFORE INSERT ON `tbl_kind_of_deck` FOR EACH ROW BEGIN
