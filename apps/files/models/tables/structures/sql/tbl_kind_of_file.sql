...
-- ----------------------------
--  Table structure for `tbl_kind_of_file`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_kind_of_file`;
CREATE TABLE `tbl_kind_of_file` (
...
delimiter ;;
CREATE TRIGGER `KindOfFile.ts_Created` BEFORE INSERT ON `tbl_kind_of_file` FOR EACH ROW BEGIN
