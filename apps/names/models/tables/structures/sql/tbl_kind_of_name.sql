...
-- ----------------------------
--  Table structure for `tbl_kind_of_name`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_kind_of_name`;
CREATE TABLE `tbl_kind_of_name` (
  `kp_KindOfNameID` int(11) NOT NULL AUTO_INCREMENT,
  `KindOfNameName` varchar(255) COLLATE utf8_bin NOT NULL,
