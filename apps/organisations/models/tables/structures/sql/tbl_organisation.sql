...
CREATE TABLE `tbl_organisation` (
  ...
  `kf_WhereaboutsID` int(11) NOT NULL DEFAULT '0' DEFAULT 0,
  `OrganisationName` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `kf_KindOfOrganisationID` int(11) NOT NULL DEFAULT '0' DEFAULT 0, 
