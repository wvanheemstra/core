...
-- ----------------------------
--  Table structure for `tbl_kind_of_plan`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_kind_of_plan`;
CREATE TABLE `tbl_kind_of_plan` (
...
delimiter ;;
CREATE TRIGGER `KindOfPlan.ts_Created` BEFORE INSERT ON `tbl_kind_of_plan` FOR EACH ROW BEGIN
