...
-- ----------------------------
--  Table structure for `tbl_kind_of_target`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_kind_of_target`;
CREATE TABLE `tbl_kind_of_target` (
...
delimiter ;;
CREATE TRIGGER `KindOfTarget.ts_Created` BEFORE INSERT ON `tbl_kind_of_target` FOR EACH ROW BEGIN
