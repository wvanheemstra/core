...
Ext.Loader.setPath({
    'Ext.ux': '/resources/js/ext/examples/ux/',
    'PageAnalyzer': '/resources/js/ext/examples/page-analyzer/'
});
...
Ext.define('PageAnalyzer.MainForm', {
    ...
    layoutTpl: [
        '<tpl if="isBoxParent">',
            '<img class="x-tree-icon" src="/resources/js/ext/examples/page-analyzer/resources/images/boxParent.gif">',
        '</tpl>',
        '{name:this.encode}',
        {
            ...
            tree = {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        width: 40,
                        items: [{
                            icon: '/resources/js/ext/examples/page-analyzer/resources/images/delete.gif',
                            iconCls: 'pgan-delete-row',
                            tooltip: 'Delete this run',
                            handler: this.onDeleteLayoutRun,
                            scope: this
                        }, {
                            icon: '/resources/js/ext/examples/page-analyzer/resources/images/info.gif',
    ...
    injectHooks: function() {
        ...
        me.injectScript('/resources/js/ext/examples/page-analyzer/hooks.js');
    },
