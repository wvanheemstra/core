 ...
 */
Ext.define("Core.mediator.extjs.booking.slide.Mediator", {
    extend: "Core.mediator.extjs.booking.base.Mediator",
	
	refs: {
		slideNav: "bookingSlideView"
	},
    ...
    getBookingSlideData: function() {
        ...
        this.getView().setLoading(nineam.locale.LocaleManager.getProperty("bookingSlide.loading"));
    ...
    onGetBookingSlideSuccess: function() {
		if(Core.config.booking.Config.getNextView()==='bookingslide') {
			...
			this.getSlide().getStore().loadRecords(this.bookingStore.getRange());
		}
    },
