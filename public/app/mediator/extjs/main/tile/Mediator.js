 ...
 */
Ext.define("Core.mediator.extjs.main.tile.Mediator", {
    ...
    getMainTileData: function() {
        ...
        var evt = Ext.create("Core.event.main.Event", Core.event.main.Event.GET_MAIN_TILE);
    ...
    showMainDetail: function(record) {
		...
		Core.config.global.Config.setPreviousView('maintile');
    ...
    onLoginSuccess: function() {
		if(Core.config.global.Config.getNextView()==='maintile') {
