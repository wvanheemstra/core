 ...
 */
Ext.define("Core.mediator.extjs.person.slide.Mediator", {
    extend: "Core.mediator.extjs.person.base.Mediator",
	
	refs: {
		slideNav: "personSlideView"
	},
    ...
    getPersonSlideData: function() {
        ...
        this.getView().setLoading(nineam.locale.LocaleManager.getProperty("personSlide.loading"));
