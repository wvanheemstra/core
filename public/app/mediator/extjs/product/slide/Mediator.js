 ...
 */
Ext.define("Core.mediator.extjs.product.slide.Mediator", {
    extend: "Core.mediator.extjs.product.base.Mediator",
	
	refs: {
		slideNav: "productSlideView"
	},
    ...
    getProductSlideData: function() {
        ...
        this.getView().setLoading(nineam.locale.LocaleManager.getProperty("productSlide.loading"));
    ...
    onGetProductSlideSuccess: function() {
		if(Core.config.product.Config.getNextView()==='productslide') {
			...
			this.getSlide().getStore().loadRecords(this.productStore.getRange());
		}
    },
