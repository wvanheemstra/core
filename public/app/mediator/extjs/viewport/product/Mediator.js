 ...
 */
Ext.define("Core.mediator.extjs.viewport.product.Mediator", {
    ...
    navigate: function(action) {
        ...
        switch(action) {
            ...
            case Core.event.authentication.Event.LOGIN_SUCCESS:
				...
				if(nextView === 'productmodal') {view = this.getViewByXType("productModalView");}				
...
//    },
    ...
    onGetSessionSuccess: function() { 
    	...
    	//Core.config.product.Config.setNextView('maintile');
