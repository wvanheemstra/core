 ...
 */
Ext.define("Core.mediator.touch.booking.tile.Mediator", {
...
// CURRENTLY WE DO NOT HAVE A SEARCH IN THE TILE VIEW
    ...
    getBookingTileData: function() {
        ...
        this.getView().setMasked({
            xtype: "loadmask",
            message: nineam.locale.LocaleManager.getProperty("bookingTile.loading")
        });
    ...
    onGetBookingTileSuccess: function() {
        ...
        this.getTile().setStore(this.bookingStore);
    },

    /**
     * Handles the get booking failure event from the login controller.
     */
    ...
    /**
     * Handles the tile disclose of a booking tile item. Shows the booking detail view passing in a reference to
