 ...
 */
Ext.define("Core.mediator.touch.product.tile.Mediator", {
...
// CURRENTLY WE DO NOT HAVE A SEARCH IN THE TILE VIEW
    ...
    getProductTileData: function() {
        ...
        this.getView().setMasked({
            xtype: "loadmask",
            message: nineam.locale.LocaleManager.getProperty("productTile.loading")
        });
    ...
    onGetProductTileSuccess: function() {
        ...
        this.getTile().setStore(this.productStore);
    },

    /**
     * Handles the get product failure event from the login controller.
     */
    ...
    /**
     * Handles the tile disclose of a product tile item. Shows the product detail view passing in a reference to
