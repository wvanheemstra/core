/**
 * The organisation group base object to facilitate model associations.
 * See:
 * http://appointsolutions.com/2012/07/using-model-associations-in-sencha-touch-2-and-ext-js-4/
 *
 * https://github.com/robboerman/SenchaAssociationsPart1/blob/master/app/model/BaseModel.js
 */
Ext.define("Core.model.organisation.group.base.Model", {
	...
	linkAssociations: function(includeAssociated, count) {
		...
		for (i = 0; i < associationCount; i++) {
			...
			if (type.toLowerCase() === 'belongsto' || type.toLowerCase() === 'hasone') {
				...
				if (associatedRecord) {
					//this[association.getInstanceName()] = associatedRecord; // ORIGINAL
					this.data[associationName] = associatedRecord.data; // FIX added by wvh
