/**
 * The slide of assets view for the application.
 *
 * <p> 
 ...
 * </p>
 */
Ext.define("Core.view.extjs.asset.slide.View", {
	extend: "Ext.Container", // WAS "Ext.Panel",
    alias: "widget.assetSlideView",
    controller: "Core.mediator.extjs.asset.slide.Mediator",
    header: false,
...
//    },
     ...
     *  otherwise this will always return the same thing (the asset container, not the
     *  selected item).
     *
