/**
 * The slide of individuals view for the application.
 *
 * <p> 
 ...
 * </p>
 */
Ext.define("Core.view.extjs.individual.slide.View", {
	extend: "Ext.Container", // WAS "Ext.Panel",
    alias: "widget.individualSlideView",
    controller: "Core.mediator.extjs.individual.slide.Mediator",
    header: false,
...
//    },
     ...
     *  otherwise this will always return the same thing (the individual container, not the
     *  selected item).
     *
