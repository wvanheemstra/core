/**
 * The slide of persons view for the application.
 *
 * <p> 
 ...
 * </p>
 */
Ext.define("Core.view.extjs.person.slide.View", {
	extend: "Ext.Container", // WAS "Ext.Panel",
    alias: "widget.personSlideView",
    controller: "Core.mediator.extjs.person.slide.Mediator",
    header: false,
