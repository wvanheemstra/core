/**
 * The event details view for the application.
 *
 * <p>
 ...
 * </p>
 */
Ext.define("Core.view.touch.event.detail.View", {
    extend: "Ext.form.Panel",
    alias: "widget.eventDetailView",
    controller: "Core.mediator.touch.event.detail.Mediator",
            ...
            },//eof toolbar
			{
				...
				items: [
					...
					//	instructions: "Please enter the information above",
						itemId: "eventDetailForm", // TO DO: rename to eventalFieldSet
						height: 330, //TEST
						defaults: {
							labelWidth: "35%"
						},
						...
						//			align: "100% 100%",
							...
							//			//html: "Hello from membership1Container",
										...
										{	
											...
											plugins: [
												{
													type: "localization",
													method: "setPlaceHolder",
													key: "eventDetail.membershipName"
												}
											]
										},{	
											xtype: "textfield",
											itemId: "event1TextField",
											name: "Event",	// TO DO					
											label: "Event",
											required: false,
											plugins: [
											...
											xtype: "hiddenfield",
											itemId: "kf_EventID0HiddenField",
											name: "Membership[0]['kf_EventID']",
											required: false,
											readOnly: true
										},{	
											xtype: "textfield",
											...
											plugins: [
												{
													type: "localization",
													method: "setPlaceHolder",
													key: "eventDetail.whereaboutsName"
												}
											]
										}]
									},{
										...
										{	
											...
											xtype: "hiddenfield",
											itemId: "kf_EventID1HiddenField",
											name: "Membership[1]['kf_EventID']",
											required: false,
											readOnly: true
										},{	
											xtype: "textfield",
