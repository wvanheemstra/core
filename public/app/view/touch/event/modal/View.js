/**
 * The modal of event view for the application.
 *
 * <p>
 ...
 * </p>
 */
 Ext.define("Core.view.touch.event.modal.View", {
    extend: "Core.view.touch.event.base.View",
    alias: "widget.eventModalView",
    controller: "Core.mediator.touch.event.modal.Mediator",
