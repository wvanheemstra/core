            ...
            },
            {
				...
				itemTpl: Ext.create('Ext.XTemplate',
						"<div class='salutationAbbreviation'>",
						  "<div style='float:left; width: 20%'>{salutationAbbreviation}</div>",
						"</div>",				
						"<div class='personFirstName'>",
						  "<div style='float:left; width: 40%'>{personFirstName}</div>",
						"</div>",
						"<div class='personLastName'>",
						  "<div style='float:left; width: 40%'>{personLastName}</div>",
						"</div>",
