glu.defModel('Core.individuals.individual', {
	alias:'widget.individualViewModel',
    model:'individual',
    ...
    isExpanded$ : function(){
        ...
        return this.rootVM.individualSetWithFocus.individualSelections.length>0;
    },
...
//    },
    ...
    save:function(){
        ...
        this.ajax({
            url:'/json/individuals/' + this.id +'/action/save',
            method:'post',
            ...
            success:function (r) {
                ...
                this.parentVM.notifyIndividualChanged();
            }
        })
    },
