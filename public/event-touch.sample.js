 ...
 * <li>Adds the views to the event Viewport when the application launches</li>
 * </ul>
 */
...
Ext.application({
    ...
    views: [
		...
		"Core.view.touch.event.slide.View",
        "Core.view.touch.event.list.View",
        "Core.view.touch.event.tile.View",
        "Core.view.touch.event.modal.View",		
        "Core.view.touch.event.detail.View"
    ],
    ...
    ////////////////////////////////////////////
    controllers:[
        //"bootstrap.Controller", // DEPRECATED, now part of "event.Controller"
        "session.Controller",   
    ...
    launch: function () {
        ...
        var viewportMediator = Ext.create("Core.mediator.touch.viewport.event.Mediator");
        viewportMediator.init();

        Ext.Viewport.add([
            { xtype: "loginView" },
			{ xtype: "eventSlideView" },
            { xtype: "eventListView" },
            { xtype: "eventTileView" },
            { xtype: "eventModalView" },	
