 ...
 * <li>Adds the views to the organisation Viewport when the application launches</li>
 * </ul>
 */
...
Ext.application({
    ...
    views: [
		...
		"Core.view.touch.organisation.slide.View",
        "Core.view.touch.organisation.list.View",
        "Core.view.touch.organisation.tile.View",
        "Core.view.touch.organisation.modal.View",		
        "Core.view.touch.organisation.detail.View"
    ],
    ...
    launch: function () {
        ...
        var viewportMediator = Ext.create("Core.mediator.touch.viewport.organisation.Mediator");
