/**
 * The product application class sets up the following:
 *
 * <ul>
 ...
 * <li>Adds the views to the product Viewport when the application launches</li>
 * </ul>
 */
Ext.onReady(function () {
    ...
    Ext.require([
        ...
        "Core.service.product.mock.Service",
		"Core.store.session.Store",
        "Core.store.product.Store",
    ...
    Deft.Injector.configure({
        ...
        productStore:			"Core.store.product.Store",
        ...
        productService:			"Core.service.product.mock.Service",
        ...
        productServiceClass: {
            value: "Core.service.product.mock.Service"
        }	
    });
...
Ext.application({
    ...
    views: [
		...
		"Core.view.touch.product.slide.View",
        "Core.view.touch.product.list.View",
        "Core.view.touch.product.tile.View",
        "Core.view.touch.product.modal.View",		
        "Core.view.touch.product.detail.View"
    ],
    ...
    ////////////////////////////////////////////
    controllers:[
        //"bootstrap.Controller",  // DEPRECATED, now part of "product.Controller"
        "session.Controller",   
    ...
    launch: function () {
        ...
        var viewportMediator = Ext.create("Core.mediator.touch.viewport.product.Mediator");
