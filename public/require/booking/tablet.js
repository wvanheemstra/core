/**
 * The booking tablet application class.
 *
...
var viewmodels = ['main', 'booking', 'booking/set', 'options'];
console.log("viewmodels = " + viewmodels);
var views = ['main', 'booking', 'booking/set', 'booking/schedule', 'booking/summary', 'options'];
