 ...
 (function(a) {
    ...
    a.fn.reveal = function(b) {
        ...
        return this.each(function() {
            ...
            d = a("." + b.dismissModalClass).bind("click.reveal",
            function() {
...
jQuery(document).ready(function(c) {
    ...
    c("form.custom select").each(function() {
		/* Added by wvh */
		if (this.getAttribute("multiple") == "multiple") { /* skip multiple selects */ } 
		else {
				a(this)
		};
    })
    ...
    c("form.custom span.custom.checkbox").live("click",
    function(e) {
        e.preventDefault();
        e.stopPropagation();
        a(c(this))
    });
    c("form.custom span.custom.radio").live("click",
    function(e) {
        e.preventDefault();
        e.stopPropagation();
        d(c(this))
    });
 	c("form.custom select").live("change",
    function(e) {
    	/* Added by wvh */  
		if (c("form.custom select").getAttribute("multiple") == "multiple") { /* skip multiple selects */ } 
		else {
        	b(c(this))
		};
    });
    c("form.custom label").live("click",
    function(f) {
    ...
    c("form.custom div.custom.dropdown a.current, form.custom div.custom.dropdown a.selector").live("click",
    function(f) {
        var h = c(this),
        ...
        if (false == e.is(":disabled")) {
            g.toggleClass("open");
            if (g.hasClass("open")) {
                c(document).bind("click.customdropdown",
                function(i) {
                    g.removeClass("open");
    ...
    c("form.custom div.custom.dropdown li").live("click",
    function(h) {
        var i = c(this),
...
/*! http://mths.be/placeholder v1.8.7 by @mathias */
 (function(o, m, r) {
    ...
    if (t && q) {
        ...
        k.textarea = q;
        r(function() {
            r(m).delegate("form", "submit.placeholder",
            function() {
            ...
            return this.each(function() {
                ...
                c(window).resize(function() {
                    ...
                    i.each(function() {
                        ...
                        f.each(function() { (c(this).data().id == j.id) ? target = c(this) : target = target
                        });
                        a.reposition(target, tip, classes)
                    })
                });
                if (Modernizr.touch) {
                    c(".tooltip").live("click touchstart touchend",
                    function(i) {
                        i.preventDefault();
                        c(this).fadeOut(150)
                    });
                    f.live("click touchstart touchend",
                    function(i) {
                        i.preventDefault();
                        c(".tooltip").hide();
            ...
            if (c(window).width() < 767) {
                ...
                if (e.indexOf("tip-top") > -1) {
                    ...
                    if (e.indexOf("tip-left") > -1) {
                        k.css({
                            top: g.offset().top - (g.outerHeight() / 2) - (h / 2),
                            left: g.offset().left - k.outerWidth() - 10,
                            width: d
                        }).removeClass("tip-override");
