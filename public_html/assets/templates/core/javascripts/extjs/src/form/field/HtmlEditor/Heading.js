 ...
 * @class Ext.form.field.HtmlEditor.HeadingButtons
...
Ext.form.field.HtmlEditor.HeadingButtons = Ext.extend(Ext.form.field.HtmlEditor.MidasCommand, {
    // private
    midasBtns: ['|', {
...
/**
 * @author Shea Frederick - http://www.vinylfox.com
 * @class Ext.form.field.HtmlEditor.HeadingMenu
 ...
 */
Ext.form.field.HtmlEditor.HeadingMenu = Ext.extend(Ext.util.Observable, {
    init: function(cmp){
        this.cmp = cmp;
