...
(function() {
	tinymce.create('tinymce.plugins.IBrowserPlugin', {
		init : function(ed, url) {
			// set url manually, to circumvent troubled url
			// var url = "http://landgoedverwolde.nl/assets/templates/core/tinymce/jscripts/tiny_mce/plugins/ibrowser";
			
			// load common script
			//tinymce.ScriptLoader.load(url + '/interface/common.js');

			// FIX for the above faulty line
