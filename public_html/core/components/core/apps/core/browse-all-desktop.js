...
Harness.start(
    ...
    // sencha examples
    {
        ...
        items       : [
            ...
            {
                group       : 'Core',  
                loaderPath  : { 'core' : 'app'}, // was { 'AM' : '025-extjs-mvc/app'},
                items               : [
                    {
                        group               : 'Sanity',
                        items               : [
                    ...
                    {
                        group               : 'Application - Person',
                        loaderPath          : { 'core' : 'app' }, // was { 'AM' : 'app' },
                        // need to set the `preload` to empty array - to avoid the double loading of dependencies
                        preload             : [],
                        items : [
                            {
                                hostPageUrl         : 'appPerson.html', // was '025-extjs-mvc/app.html',
                                url                 : '014_appPerson.t.js' // was '025-extjs-mvc/tests/014_app.t.js'
                            }
                        ]
                    }
                ]
