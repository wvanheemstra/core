<?php
/**
 *  core.MQLRead Snippet
 *
 *  NOTE: Set two parameter value below:
 *  1) $metadata_file_name inside function init_metadata() 
 *  2) $connection_file_name inside function init_pdo()
*/
...
function init_metadata(){
    ...
    // We have to redefine the schema file location again here, because it is out-of-scope.
    $metadata_file_name = MODX_ASSETS_PATH . 'templates/core/schemas/schema-core.json';
...
function init_pdo(){
    ...
    // We have to redefine the connection file location again here, because it is out-of-scope.
    $connection_file_name = MODX_ASSETS_PATH . 'templates/core/schemas/connection-mysql-core.json';
