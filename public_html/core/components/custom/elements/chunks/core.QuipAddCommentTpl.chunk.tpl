...
<div class="quip-comment quip-add-comment">
    ...
    <button type="submit" name="[[+preview_action]]" value="1" class="nice small white button">[[%quip.preview]]</button>
    [[+can_post:is=`1`:then=`<button type="submit" name="[[+post_action]]" value="1" class="nice small white button">[[%quip.post]]</button>`]]
