...
module.exports = function (grunt) {
	...
	grunt.registerTask("instrument", "instruments a file or a directory tree", function (target) {
		...
		helper.instrument(grunt.file.expand(files), options, this.async());
	});
	...
	grunt.registerTask("storeCoverage", "store coverage from global", function (target) {
		var options = this.options({
			dir : "build/reports/",
			json : "coverage.json",
